...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_split_3x5_2(
        ...
        KC_A,       KC_R,       KC_S,       KC_T,       KC_G,                   KC_M,       KC_N,   KC_E,       KC_I,   RCTL_T(KC_O),
    ...
    [NAV] = LAYOUT_split_3x5_2(
        KC_ESC,      KC_NO,       KC_NO,        KC_NO,       KC_NO,             KC_NO,      KC_D,       KC_U,      KC_NO,   KC_DEL,
    ...
    [NUM] = LAYOUT_split_3x5_2(
        ...
        KC_1,       KC_2,       KC_3,       KC_4,       KC_5,                   KC_NO,  OS_CTRL,    OS_CMD,     OS_ALT,      OS_SHFT,
